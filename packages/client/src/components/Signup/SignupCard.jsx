  ...
  return (
    <div className='flex flex-col'>
      <div className='bg-white rounded-[10px] px-5 py-10 flex flex-col md:w-[500px]'>
          ...
          <button onClick={() => Signup(email, password, name, date, phone, address)} className='feather bg-green-400 hover:bg-green-500 text-white rounded px-3 py-1 mt-5'>Signup</button>
      </div>
      <p className='text-black feather'>Already have an account? <Link to='/login' className='text-green-500'>Sign in</Link> </p>
    </div>
  )
}

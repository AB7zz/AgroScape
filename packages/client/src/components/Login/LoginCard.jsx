  ...
  return (
    <div className='flex flex-col'>
      <div className='bg-white rounded-[10px] px-5 py-10 flex flex-col md:w-[500px]'>
          ...
          <button onClick={() => Login(email, password)} className='feather bg-green-400 hover:bg-green-500 text-white rounded px-3 py-1 mt-5'>Login</button>
      </div>
      <p className='text-black feather'>Don't have an account? <Link to='/signup' className='text-green-500'>Sign up</Link> </p>
    </div>
  )
}
